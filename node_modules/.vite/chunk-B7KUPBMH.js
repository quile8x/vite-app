...
} from "./chunk-XXATTQAM.js";
import {
  useResolveEnsAddress,
  useResolveEnsName
} from "./chunk-CKBXXWKU.js";
import {
  transactor
} from "./chunk-H7Y5WOLT.js";
import {
  EthComponentsSettingsContext,
  __objRest,
  __spreadProps,
  __spreadValues
} from "./chunk-NOVIHONR.js";
import {
  require_prop_types
} from "./chunk-DEXFUADQ.js";
import {
  badge_default,
  button_default,
  card_default,
...
import {
  ...
  formatUnits,
  parseEther
} from "./chunk-IHJAWPOH.js";
import {
  BigNumber
} from "./chunk-2FOUMDTB.js";
import {
  useThemeSwitcher
} from "./chunk-XB5OHGV3.js";
import {
  require_react
...
var require_lib = __commonJS({
  "node_modules/react-qr-reader/lib/index.js"(exports, module) {
    ...
    var Component = React10.Component;
    ...
    module.exports = (_temp = _class = function(_Component) {
      ...
      _createClass(Reader, [{
        ...
        value: function render() {
          ...
          return React10.createElement("section", { className, style }, React10.createElement("section", { style: containerStyle }, !legacyMode && showViewFinder ? React10.createElement("div", { style: viewFinderStyle }) : null, legacyMode ? React10.createElement("input", {
            style: hiddenStyle,
            type: "file",
            accept: "image/*",
            ref: this.setRefFactory("input"),
            onChange: this.handleInputChange
          }) : null, legacyMode ? React10.createElement("img", { style: imgPreviewStyle, ref: this.setRefFactory("img"), onLoad: onImageLoad }) : React10.createElement("video", { style: videoPreviewStyle, ref: this.setRefFactory("preview") }), React10.createElement("canvas", { style: hiddenStyle, ref: this.setRefFactory("canvas") })));
        }
      }]);
      return Reader;
...
var require_lib2 = __commonJS({
  "node_modules/qrcode.react/lib/index.js"(exports, module) {
    ...
    var QRCodeCanvas = function(_React$PureComponent) {
      ...
      _createClass(QRCodeCanvas2, [{
        ...
        value: function render() {
          ...
          return React10.createElement(React10.Fragment, null, React10.createElement("canvas", _extends({
            style: canvasStyle,
            height: size,
            width: size,
      ...
      _createClass(QRCodeSVG2, [{
        ...
        value: function render() {
          ...
          if (imageSettings != null && calculatedImageSettings != null) {
            ...
            image = React10.createElement("image", {
          ...
          }, otherProps), React10.createElement("path", {
            fill: bgColor,
    ...
    var QRCode = function QRCode2(props) {
      ...
      return React10.createElement(Component, otherProps);
    };
...
// node_modules/eth-components/chunk-CI23DQ7E.js
init_define_process_env();
var import_react = __toModule(require_react());
var import_react2 = __toModule(require_react());
var import_react_blockies = __toModule(require_main());
var import_react3 = __toModule(require_react());
var import_react4 = __toModule(require_react());
var import_react_qr_reader = __toModule(require_lib());
var import_react5 = __toModule(require_react());
var import_react6 = __toModule(require_react());
var import_react_blockies2 = __toModule(require_main());
var import_react7 = __toModule(require_react());
var import_react8 = __toModule(require_react());
var import_react_blockies3 = __toModule(require_main());
var import_react9 = __toModule(require_react());
var import_qrcode = __toModule(require_lib2());
var import_react10 = __toModule(require_react());
var import_qrcode2 = __toModule(require_lib2());
var import_react11 = __toModule(require_react());
var import_react12 = __toModule(require_react());
var import_react13 = __toModule(require_react());
var import_react_blockies4 = __toModule(require_main());
var import_react14 = __toModule(require_react());
var import_react15 = __toModule(require_react());
var Account = (props) => {
  let blockNumber = useBlockNumberContext(), ethersContext = useEthersContext(), showLoadModal = !ethersContext.active, [connecting, setConnecting] = (0, import_react3.useState)(false), isMounted = useIsMounted_default(), [loadingButton, loadingButtonDebounce] = useDebounce(connecting, 1e3, { maxWait: 1500 });
  loadingButton && connecting && setConnecting(false);
  let address = useUserAddress(props.signer), [resolvedAddress] = useDebounce(props.hasContextConnect ? ethersContext.account : address, 200, { trailing: true }), [resolvedSigner] = useDebounce(props.hasContextConnect ? ethersContext.signer : props.signer, 200, { trailing: true }), handleLoginClick = () => {
    var _a;
    if (props.createLoginConnector != null) {
      let connector = (_a = props.createLoginConnector) == null ? void 0 : _a.call(props);
      isMounted() ? connector ? (setConnecting(true), ethersContext.openModal(connector)) : console.warn("openModal: A valid EthersModalConnector was not provided") : console.log("openModal: no longer mounted");
    }
  }, loadModalButton = import_react3.default.createElement(import_react3.default.Fragment, null, showLoadModal && props.createLoginConnector && import_react3.default.createElement(button_default, { loading: loadingButtonDebounce.isPending(), key: "loginbutton", style: { verticalAlign: "top", marginLeft: 8, marginTop: 4 }, shape: "round", size: "large", onClick: handleLoginClick }, "connect")), logoutButton = import_react3.default.createElement(import_react3.default.Fragment, null, !showLoadModal && props.createLoginConnector && import_react3.default.createElement(button_default, { key: "logoutbutton", style: { verticalAlign: "top", marginLeft: 8, marginTop: 4 }, shape: "round", size: "large", onClick: ethersContext.disconnectModal }, "logout")), { currentTheme } = useThemeSwitcher(), display = import_react3.default.createElement("span", null, resolvedAddress != null && import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement(Address, { punkBlockie: true, address: resolvedAddress, fontSize: props.fontSize, ensProvider: props.ensProvider, blockExplorer: props.blockExplorer, minimized: false }), import_react3.default.createElement(Balance, { address: resolvedAddress, price: props.price }), resolvedSigner && import_react3.default.createElement(Wallet, { signer: resolvedSigner, ensProvider: props.ensProvider, localProvider: props.localProvider, price: props.price, color: currentTheme === "light" ? "#1890ff" : "#2caad9" })));
  return import_react3.default.createElement("div", null, display, props.hasContextConnect && import_react3.default.createElement(import_react3.default.Fragment, null, loadModalButton, logoutButton));
};
var AddressInput = (props) => {
  var _a, _b;
  let [scan, setScan] = (0, import_react4.useState)(false), ensName = useResolveEnsName(props.ensProvider, (_a = props.address) != null ? _a : ""), scannerButton = import_react4.default.createElement("div", { style: { marginTop: 4, cursor: "pointer" }, onClick: () => {
    setScan(!scan);
  } }, import_react4.default.createElement(badge_default, { count: import_react4.default.createElement(CameraOutlined_default, { style: { fontSize: 9 } }) }, import_react4.default.createElement(QrcodeOutlined_default, { style: { fontSize: 18 } })), " ", "Scan"), updateAddress = (0, import_react4.useCallback)(async (newValue) => {
    var _a2, _b2;
    if (newValue != null) {
      let address = newValue;
      if (address.indexOf(".eth") > 0 || address.indexOf(".xyz") > 0)
        try {
          let possibleAddress = await ((_b2 = (_a2 = props.ensProvider) == null ? void 0 : _a2.resolveName) == null ? void 0 : _b2.call(_a2, address));
          possibleAddress && (address = possibleAddress);
        } catch {
        }
      props.onChange && props.onChange(address);
    }
  }, [props.ensProvider, props.onChange]);
  return import_react4.default.createElement("div", null, scan ? import_react4.default.createElement("div", { style: { zIndex: 256, position: "absolute", left: 0, top: 0, width: "100%" }, onClick: () => {
    setScan(false);
  } }, import_react4.default.createElement(import_react_qr_reader.default, { delay: 250, resolution: 1200, onError: (e) => {
    console.log("SCAN ERROR", e), setScan(false);
  }, onScan: (newValue) => {
    if (newValue) {
      console.log("SCAN VALUE", newValue);
      let possibleNewValue = newValue;
      possibleNewValue.indexOf("/") >= 0 && (possibleNewValue = possibleNewValue.substr(possibleNewValue.lastIndexOf("0x")), console.log("CLEANED VALUE", possibleNewValue)), setScan(false), updateAddress(possibleNewValue);
    }
  }, style: { width: "100%" } })) : "", import_react4.default.createElement(input_default, { id: "0xAddress", name: "0xAddress", autoComplete: "off", autoFocus: props.autoFocus, placeholder: props.placeholder ? props.placeholder : "address", prefix: import_react4.default.createElement(Blockie, { address: (_b = props.address) != null ? _b : "", scale: 3 }), value: ensName || props.address, addonAfter: scannerButton, onChange: (e) => {
    updateAddress(e.target.value);
  } }));
};
var Balance = (props) => {
  var _a, _b;
  let [dollarMode, setDollarMode] = (0, import_react5.useState)(true), balance = useBalance(props.address), resolvedBalance = BigNumber.from(balance);
  props.balance != null && (resolvedBalance = BigNumber.from(props.balance));
  let floatBalance = parseFloat("0.00");
  if (resolvedBalance) {
    let etherBalance = formatEther(resolvedBalance);
    floatBalance = parseFloat(etherBalance);
  }
  let display = floatBalance.toFixed(4), price = (_a = props.price) != null ? _a : props.dollarMultiplier;
  return price && dollarMode && (display = "$" + (floatBalance * price).toFixed(2)), import_react5.default.createElement("span", { style: { verticalAlign: "middle", fontSize: (_b = props.size) != null ? _b : 24, padding: 8, cursor: "pointer" }, onClick: () => {
    setDollarMode(!dollarMode);
  } }, display);
};
var Blockie = (props) => !props.address || typeof props.address.toLowerCase != "function" ? import_react6.default.createElement("span", null) : import_react6.default.createElement(import_react_blockies2.default, __spreadValues({ seed: props.address.toLowerCase() }, props));
var EtherInput = (props) => {
  let [mode, setMode] = (0, import_react7.useState)(props.price ? "USD" : "ETH"), [display, setDisplay] = (0, import_react7.useState)(), [value, setValue] = (0, import_react7.useState)(), currentValue = props.value ? props.value : value, option = (title) => (props == null ? void 0 : props.price) != null ? import_react7.default.createElement(import_react7.default.Fragment, null) : import_react7.default.createElement("div", { style: { cursor: "pointer" }, onClick: () => {
    if (mode === "USD")
      setMode("ETH"), setDisplay(currentValue);
    else if (setMode("USD"), currentValue) {
      let usdValue = "" + (parseFloat(currentValue) * props.price).toFixed(2);
      setDisplay(usdValue);
    } else
      setDisplay(currentValue);
  } }, title), prefix, addonAfter;
  return mode === "USD" ? (prefix = "$", addonAfter = option("USD \u{1F500}")) : (prefix = "\u039E", addonAfter = option("ETH \u{1F500}")), (0, import_react7.useEffect)(() => {
    currentValue || setDisplay("");
  }, [currentValue]), import_react7.default.createElement(input_default, { placeholder: props.placeholder ? props.placeholder : "amount in " + mode, autoFocus: props.autoFocus, prefix, value: display, addonAfter, onChange: (e) => {
    var _a;
    let newValue = e.target.value;
    if (mode === "USD") {
      let possibleNewValue = parseFloat(newValue);
      if (possibleNewValue) {
        let ethValue = possibleNewValue / ((_a = props.price) != null ? _a : 1);
        setValue(ethValue.toString()), typeof props.onChange == "function" && props.onChange(ethValue.toString()), setDisplay(newValue);
      } else
        setDisplay(newValue);
    } else
      setValue(newValue), typeof props.onChange == "function" && props.onChange(newValue), setDisplay(newValue);
  } });
};
var Faucet = (props) => {
  let [recipient, setRecipient] = (0, import_react8.useState)(""), context = (0, import_react8.useContext)(EthComponentsSettingsContext), blockie;
  props.faucetAddress && typeof props.faucetAddress.toLowerCase == "function" ? blockie = import_react8.default.createElement(import_react_blockies3.default, { seed: props.faucetAddress.toLowerCase(), size: 8, scale: 4 }) : blockie = import_react8.default.createElement("div", null);
  let updateAddress = (0, import_react8.useCallback)((newValue) => {
    newValue != null && setRecipient(newValue);
  }, []), resolvedAddress = useResolveEnsAddress(props.mainnetProvider, recipient != null ? recipient : ""), toAddress = ethers_exports.utils.isAddress(recipient) ? recipient : resolvedAddress, localSigner = props.localProvider.getSigner();
  return import_react8.default.createElement("span", null, import_react8.default.createElement(input_default, { size: "large", placeholder: props.placeholder ? props.placeholder : "local faucet", prefix: blockie, value: recipient, onChange: (e) => {
    updateAddress(e.target.value);
  }, suffix: import_react8.default.createElement(tooltip_default, { title: "Faucet: Send local ether to an address." }, import_react8.default.createElement(button_default, { onClick: () => {
    if (localSigner && context && ethers_exports.utils.isAddress(toAddress)) {
      let tx = transactor(context, localSigner);
      tx && !!recipient && tx({ to: toAddress, value: parseEther("0.01") }).then(() => {
        setRecipient("");
      });
    } else
      console.warn("Faucet: invalid address");
  }, shape: "circle", icon: import_react8.default.createElement(SendOutlined_default, null) }), import_react8.default.createElement(Wallet, { color: "#888888", signer: localSigner, localProvider: props.localProvider, ensProvider: props.mainnetProvider, price: props.price })) }));
};
var GasGauge = (props) => {
  let gasPrice = useGasPrice(props.chainId, props.speed, props.currentNetwork);
  return import_react9.default.createElement(button_default, { onClick: () => {
    window.open("https://ethgasstation.info/");
  }, size: "large", shape: "round" }, import_react9.default.createElement("span", { style: { marginRight: 8 } }, import_react9.default.createElement("span", { role: "img", "aria-label": "fuelpump" }, "\u26FD\uFE0F")), gasPrice != null ? gasPrice : "\u2753");
};
var useWindowSize = () => {
  let isClient = typeof window == "object";
  function getSize() {
    return { width: isClient ? window.innerWidth : void 0, height: isClient ? window.innerHeight : void 0 };
  }
  let [windowSize, setWindowSize] = (0, import_react10.useState)(getSize);
  return (0, import_react10.useEffect)(() => {
    let handleResize = () => {
      setWindowSize(getSize());
    };
    return isClient && window.addEventListener("resize", handleResize), () => {
      window.removeEventListener("resize", handleResize);
    };
  }, []), windowSize;
};
var PunkBlockie = (props) => {
  var _a, _b;
  let size = useWindowSize();
  size.width || (size.width = 100), size.height || (size.height = 100);
  let minSize = 360, qrWidth;
  size.width && size.width / 3 < minSize ? qrWidth = minSize : qrWidth = (_a = size.width) != null ? _a : minSize / 3;
  let scale = (_b = props.scale) != null ? _b : Math.min(size.height - 130, size.width, 1024) / (qrWidth * 1), offset = 0.42, url = window.location.href + "", hardcodedSizeForNow = 380, punkSize = 112, part1 = props.address && props.address.substr(2, 20), part2 = props.address && props.address.substr(22), x = parseInt(part1, 16) % 100, y = parseInt(part2, 16) % 100;
  return import_react10.default.createElement("div", { style: { transform: `scale(${props.scale ? props.scale : "1"})`, transformOrigin: "50% 50%", margin: "auto", position: "relative", width: hardcodedSizeForNow }, onClick: () => {
    let el = document.createElement("textarea");
    el.value = props.address, document.body.appendChild(el), el.select(), document.execCommand("copy"), document.body.removeChild(el);
    let iconPunkSize = 40;
    message_default.success(import_react10.default.createElement("span", { style: { position: "relative" } }, "Copied Address", import_react10.default.createElement("div", { style: { position: "absolute", left: -60, top: -14 } }, import_react10.default.createElement("div", { style: { position: "relative", width: iconPunkSize, height: iconPunkSize - 1, overflow: "hidden" } }, import_react10.default.createElement("img", { src: "/punks.png", style: { position: "absolute", left: -iconPunkSize * x, top: -iconPunkSize * y, width: iconPunkSize * 100, height: iconPunkSize * 100, imageRendering: "pixelated" } })))));
  } }, import_react10.default.createElement("div", { style: { position: "absolute", opacity: 0.5, left: hardcodedSizeForNow / 2 - 46, top: hardcodedSizeForNow / 2 - 46 } }, import_react10.default.createElement(Blockie, { address: props.address, scale: 11.5 })), import_react10.default.createElement("div", { style: { position: "absolute", left: hardcodedSizeForNow / 2 - 53, top: hardcodedSizeForNow / 2 - 65 } }, import_react10.default.createElement("div", { style: { position: "relative", width: punkSize, height: punkSize - 1, overflow: "hidden" } }, import_react10.default.createElement("img", { src: "/punks.png", style: { position: "absolute", left: -punkSize * x, top: -punkSize * y - 1, width: punkSize * 100, height: punkSize * 100, imageRendering: "pixelated" } }))), props.withQr ? import_react10.default.createElement(import_qrcode.default, { level: "H", includeMargin: false, value: props.address ? "ethereum:" + props.address : "", size: hardcodedSizeForNow, imageSettings: { width: 105, height: 105, excavate: true, src: "qr" } }) : "");
};
var { Text, Paragraph } = typography_default;
var Wallet = (props) => {
  var _a;
  let burner = useBurnerSigner(props.localProvider), account = useUserAddress(props.signer), [open, setOpen] = (0, import_react11.useState)(false), [qr, setQr] = (0, import_react11.useState)(), [amount, setAmount] = (0, import_react11.useState)(""), [toAddress, setToAddress] = (0, import_react11.useState)(""), [publicKey, setPublicKey] = (0, import_react11.useState)(), context = (0, import_react11.useContext)(EthComponentsSettingsContext), providerSend = props.signer ? import_react11.default.createElement(tooltip_default, { title: "Wallet" }, import_react11.default.createElement(WalletOutlined_default, { onClick: () => {
    setOpen(!open);
  }, rotate: -90, style: { padding: 7, color: props.color ? props.color : "", cursor: "pointer", fontSize: 28, verticalAlign: "middle" } })) : import_react11.default.createElement(import_react11.default.Fragment, null), display, receiveButton, privateKeyButton;
  if (qr)
    display = import_react11.default.createElement("div", null, import_react11.default.createElement("div", null, import_react11.default.createElement(Text, { copyable: true }, account)), import_react11.default.createElement(import_qrcode2.default, { value: account != null ? account : "", size: 450, level: "H", includeMargin: true, renderAs: "svg", imageSettings: { excavate: false, src: "copy" } })), receiveButton = import_react11.default.createElement(button_default, { key: "hide", onClick: () => {
      setQr("");
    } }, import_react11.default.createElement(QrcodeOutlined_default, null), " Hide"), privateKeyButton = import_react11.default.createElement(button_default, { key: "hide", onClick: () => {
      setPublicKey(account), setQr("");
    } }, import_react11.default.createElement(KeyOutlined_default, null), " Private Key");
  else if (publicKey) {
    if ((props.signer == null || account == null) && (display = import_react11.default.createElement("div", null, import_react11.default.createElement("b", null, "*initalizing*"))), burner.account == null)
      display = import_react11.default.createElement("div", null, import_react11.default.createElement("b", null, "*unknown*, burner signer not initalized"));
    else if (burner.account !== account)
      display = import_react11.default.createElement("div", null, import_react11.default.createElement("b", null, "*injected account*, burner private key unknown"));
    else {
      let burnerPrivateKey = (_a = burner.getBurnerPrivateKey()) != null ? _a : "";
      display = import_react11.default.createElement("div", null, import_react11.default.createElement("b", null, "Private Key:"), import_react11.default.createElement("div", null, import_react11.default.createElement(Text, { copyable: true }, burnerPrivateKey)), import_react11.default.createElement("hr", null), import_react11.default.createElement("i", null, "Point your camera phone at qr code to open in", import_react11.default.createElement("a", { target: "_blank", href: "https://xdai.io/" + burnerPrivateKey, rel: "noopener noreferrer" }, "burner wallet"), ":"), import_react11.default.createElement(import_qrcode2.default, { value: "https://xdai.io/" + burnerPrivateKey, size: 450, level: "H", includeMargin: true, renderAs: "svg", imageSettings: { excavate: false, src: "dai" } }), import_react11.default.createElement(Paragraph, { style: { fontSize: "16" }, copyable: true }, "https://xdai.io/" + burnerPrivateKey));
    }
    receiveButton = import_react11.default.createElement(button_default, { key: "receive", onClick: () => {
      setQr(account), setPublicKey("");
    } }, import_react11.default.createElement(QrcodeOutlined_default, null), " Receive"), privateKeyButton = import_react11.default.createElement(button_default, { key: "hide", onClick: () => {
      setPublicKey(""), setQr("");
    } }, import_react11.default.createElement(KeyOutlined_default, null), " Hide");
  } else {
    let inputStyle = { padding: 10 };
    display = import_react11.default.createElement("div", null, import_react11.default.createElement("div", { style: inputStyle }, import_react11.default.createElement(AddressInput, { autoFocus: true, ensProvider: props.ensProvider, placeholder: "to address", address: toAddress, onChange: setToAddress })), import_react11.default.createElement("div", { style: inputStyle }, import_react11.default.createElement(EtherInput, { price: props.price, value: amount, onChange: (value) => {
      setAmount(value);
    } }))), receiveButton = import_react11.default.createElement(button_default, { key: "receive", onClick: () => {
      setQr(account), setPublicKey("");
    } }, import_react11.default.createElement(QrcodeOutlined_default, null), " Receive"), privateKeyButton = import_react11.default.createElement(button_default, { key: "hide", onClick: () => {
  ...
  let disableSend = amount == null || toAddress == null || qr != null && qr !== "";
  return import_react11.default.createElement("span", null, providerSend, import_react11.default.createElement(modal_default, { visible: open, title: import_react11.default.createElement("div", null, account ? import_react11.default.createElement(Address, { address: account, ensProvider: props.ensProvider }) : import_react11.default.createElement(spin_default, null), import_react11.default.createElement("div", { style: { float: "right", paddingRight: 25 } }, import_react11.default.createElement(Balance, { address: account, dollarMultiplier: props.price }))), onOk: () => {
    setQr(""), setPublicKey(""), setOpen(!open);
  }, onCancel: () => {
    setQr(""), setPublicKey(""), setOpen(!open);
  }, footer: [privateKeyButton, receiveButton, import_react11.default.createElement(button_default, { key: "submit", type: "primary", disabled: disableSend, loading: false, onClick: () => {
    let tx = transactor(context, props.signer), value;
    try {
      value = parseEther("" + amount);
    } catch {
      value = parseEther("" + parseFloat(amount).toFixed(8));
    }
    tx == null || tx({ to: toAddress, value }), setOpen(!open), setQr("");
  } }, import_react11.default.createElement(SendOutlined_default, null), " Send")] }, display));
};
var { Text: Text2, Link } = typography_default;
var blockExplorerLink = (address, blockExplorer) => `${blockExplorer || "https://etherscan.io/"}address/${address}`;
var Address = (_a) => {
  var _b = _a, { minimized = false, punkBlockie = false, size = "short" } = _b, rest = __objRest(_b, ["minimized", "punkBlockie", "size"]);
  let props = __spreadProps(__spreadValues({}, rest), { size, minimized, punkBlockie }), address = props.address, ensName = "", { currentTheme } = useThemeSwitcher();
  if (ensName = useResolveEnsName(props.ensProvider, address), !address)
    return import_react2.default.createElement("span", null, import_react2.default.createElement(skeleton_default, { avatar: true, paragraph: { rows: 1 } }));
  let displayAddress = address.substr(0, 6), ensSplit = ensName && ensName.split(".");
  ensSplit && ensSplit[ensSplit.length - 1] === "eth" ? displayAddress = ensName : props.size === "short" ? displayAddress += "..." + address.substr(-4) : props.size === "long" && (displayAddress = address);
  let etherscanLink = blockExplorerLink(address, props.blockExplorer);
  if (props.minimized)
    return props.noLink ? import_react2.default.createElement("span", { style: { verticalAlign: "middle" } }, import_react2.default.createElement("span", { style: { verticalAlign: "middle", position: "relative" } }, import_react2.default.createElement("div", { style: { position: "absolute", left: -213, top: -62 } }, import_react2.default.createElement(PunkBlockie, { withQr: false, address: address.toLowerCase(), scale: 0.35 })))) : import_react2.default.createElement("span", { style: { verticalAlign: "middle" } }, import_react2.default.createElement("a", { style: { color: currentTheme === "light" ? "#222222" : "#ddd" }, target: "_blank", href: etherscanLink, rel: "noopener noreferrer" }, import_react2.default.createElement("span", { style: { verticalAlign: "middle", position: "relative" } }, import_react2.default.createElement("div", { style: { position: "absolute", left: -213, top: -62 } }, import_react2.default.createElement(PunkBlockie, { withQr: false, address: address.toLowerCase(), scale: 0.35 })))));
  let copyable = props.hideCopy ? void 0 : { text: address }, text = import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement(Link, { style: { color: currentTheme === "light" ? "#222222" : "#ddd" }, editable: props.onChange ? { onChange: props.onChange } : false, copyable, href: etherscanLink, target: "_blank" }, displayAddress));
  return import_react2.default.createElement("span", { style: { position: "relative" } }, props.punkBlockie ? import_react2.default.createElement("span", { style: { verticalAlign: "middle" } }, import_react2.default.createElement("div", { style: { position: "absolute", left: -213, top: -62 } }, import_react2.default.createElement(PunkBlockie, { withQr: false, address: address.toLowerCase(), scale: 0.4 }))) : import_react2.default.createElement("span", { style: { verticalAlign: "middle" } }, import_react2.default.createElement(import_react_blockies.default, { seed: address.toLowerCase(), size: 8, scale: props.fontSize ? props.fontSize / 7 : 4 })), import_react2.default.createElement("span", { style: { verticalAlign: "middle", paddingLeft: 5, fontSize: props.fontSize ? props.fontSize : 28 } }, text));
};
var tryToDisplay = (thing) => {
  if (thing == null)
    return "";
  ...
  return thing && typeof thing == "string" && thing.indexOf("0x") === 0 && thing.length === 42 ? import_react.default.createElement(Address, { address: thing, fontSize: 22 }) : JSON.stringify(thing);
};
var DisplayVariable = (props) => {
  let [variable, setVariable] = (0, import_react12.useState)(""), isMounted = useIsMounted_default(), refresh = (0, import_react12.useCallback)(async () => {
    try {
      if (props.contractFunction) {
        let result = await props.contractFunction();
        isMounted() && (setVariable(result), props.setTriggerRefresh(false));
      }
    } catch (e) {
      console.log(e);
    }
  ...
  return (0, import_react12.useEffect)(() => {
    refresh();
  }, [refresh, props.refreshRequired, props.contractFunction]), import_react12.default.createElement("div", null, import_react12.default.createElement(row_default, null, import_react12.default.createElement(col_default, { span: 8, style: { textAlign: "right", opacity: 0.333, paddingRight: 6, fontSize: 24 } }, props.functionInfo.name), import_react12.default.createElement(col_default, { span: 14 }, import_react12.default.createElement("h2", null, tryToDisplay(variable))), import_react12.default.createElement(col_default, { span: 2 }, import_react12.default.createElement("h2", null, import_react12.default.createElement("a", { href: "#", onClick: refresh }, "\u{1F504}")))), import_react12.default.createElement(divider_default, null));
};
var getFunctionInputKey = (functionInfo, input, inputIndex) => {
  let name = (input == null ? void 0 : input.name) ? input.name : `input_${inputIndex}_`;
  return functionInfo.name + "_" + name + "_" + input.type;
};
var FunctionForm = (props) => {
  let [form, setForm] = (0, import_react13.useState)({}), [txValue, setTxValue] = (0, import_react13.useState)(""), [returnValue, setReturnValue] = (0, import_react13.useState)(), ethersContext = useEthersContext(), ethComponentsSettings = (0, import_react13.useContext)(EthComponentsSettingsContext), inputs = props.functionFragment.inputs.map((input, inputIndex) => {
    let key = getFunctionInputKey(props.functionFragment, input, inputIndex), buttons = import_react13.default.createElement(import_react13.default.Fragment, null);
    if (input.type === "bytes32")
      buttons = import_react13.default.createElement(tooltip_default, { placement: "right", title: "to bytes32" }, import_react13.default.createElement("div", { style: { cursor: "pointer" }, onClick: () => {
        if (utils_exports.isHexString(form[key])) {
          let formUpdate = __spreadValues({}, form);
          formUpdate[key] = utils_exports.parseBytes32String(form[key]), setForm(formUpdate);
        } else {
          let formUpdate = __spreadValues({}, form);
          formUpdate[key] = utils_exports.formatBytes32String(form[key]), setForm(formUpdate);
        }
      } }, "#\uFE0F\u20E3"));
    else if (input.type === "bytes")
      buttons = import_react13.default.createElement(tooltip_default, { placement: "right", title: "to hex" }, import_react13.default.createElement("div", { style: { cursor: "pointer" }, onClick: () => {
        if (utils_exports.isHexString(form[key])) {
          let formUpdate = __spreadValues({}, form);
          formUpdate[key] = utils_exports.toUtf8String(form[key]), setForm(formUpdate);
        } else {
          let formUpdate = __spreadValues({}, form);
          formUpdate[key] = utils_exports.hexlify(utils_exports.toUtf8Bytes(form[key])), setForm(formUpdate);
        }
      } }, "#\uFE0F\u20E3"));
    else if (input.type === "uint256")
      buttons = import_react13.default.createElement(tooltip_default, { placement: "right", title: "* 10 ** 18" }, import_react13.default.createElement("div", { style: { cursor: "pointer" }, onClick: () => {
        let formUpdate = __spreadValues({}, form);
        formUpdate[key] = utils_exports.parseEther(form[key]), setForm(formUpdate);
      } }, "\u2734\uFE0F"));
    else if (input.type === "address") {
      let possibleAddress = form[key] && form[key].toLowerCase && form[key].toLowerCase().trim();
      possibleAddress && possibleAddress.length === 42 && (buttons = import_react13.default.createElement(tooltip_default, { placement: "right", title: "blockie" }, import_react13.default.createElement(import_react_blockies4.default, { seed: possibleAddress, scale: 3 })));
    }
    return import_react13.default.createElement("div", { style: { margin: 2 }, key }, import_react13.default.createElement(input_default, { size: "large", placeholder: input.name ? input.type + " " + input.name : input.type, autoComplete: "off", value: form[key], name: key, onChange: (event) => {
      let formUpdate = __spreadValues({}, form);
      formUpdate[event.target.name] = event.target.value, setForm(formUpdate);
    }, suffix: buttons }));
  }), txValueInput = import_react13.default.createElement("div", { style: { margin: 2 }, key: "txValueInput" }, import_react13.default.createElement(input_default, { placeholder: "transaction value", onChange: (e) => setTxValue(e.target.value), value: txValue, addonAfter: import_react13.default.createElement("div", null, import_react13.default.createElement(row_default, null, import_react13.default.createElement(col_default, { span: 16 }, import_react13.default.createElement(tooltip_default, { placement: "right", title: " * 10^18 " }, import_react13.default.createElement("div", { style: { cursor: "pointer" }, onClick: () => {
    let floatValue = parseFloat(txValue);
    floatValue && setTxValue(`${floatValue * 10 ** 18}`);
  } }, "\u2733\uFE0F"))), import_react13.default.createElement(col_default, { span: 16 }, import_react13.default.createElement(tooltip_default, { placement: "right", title: "number to hex" }, import_react13.default.createElement("div", { style: { cursor: "pointer" }, onClick: () => {
    setTxValue(BigNumber.from(txValue).toHexString());
  } }, "#\uFE0F\u20E3"))))) }));
  props.functionFragment.payable && inputs.push(txValueInput);
  let buttonIcon = props.functionFragment.type === "call" ? import_react13.default.createElement(button_default, { style: { marginLeft: -32 } }, "Read\u{1F4E1}") : import_react13.default.createElement(button_default, { style: { marginLeft: -32 } }, "Send\u{1F4B8}");
  return inputs.push(import_react13.default.createElement("div", { style: { cursor: "pointer", margin: 2 }, key: "goButton" }, import_react13.default.createElement(input_default, { onChange: (e) => setReturnValue(e.target.value), defaultValue: "", bordered: false, disabled: true, value: returnValue, suffix: import_react13.default.createElement("div", { style: { width: 50, height: 30, margin: 0 }, onClick: async () => {
    let args = props.functionFragment.inputs.map((input, inputIndex) => {
      let key = getFunctionInputKey(props.functionFragment, input, inputIndex), value = form[key];
      return input.baseType === "array" ? value = JSON.parse(value) : input.type === "bool" && (value === "true" || value === "1" || value === "0x1" || value === "0x01" || value === "0x0001" ? value = 1 : value = 0), value;
    }), result;
    if (props.functionFragment.stateMutability === "view" || props.functionFragment.stateMutability === "pure")
      try {
        let returned = await props.contractFunction(...args);
      ...
      let overrides = {};
      txValue && (overrides.value = txValue), props.gasPrice && (overrides.gasPrice = props.gasPrice);
      let tx = transactor(ethComponentsSettings, ethersContext.signer, props.gasPrice);
      if (tx && (ethersContext == null ? void 0 : ethersContext.chainId) != null) {
        let returned = await tx(props.contractFunction(...args, overrides));
        result = tryToDisplay(returned);
      }
    }
    console.log("SETTING RESULT:", result), setReturnValue(result), props.setTriggerRefresh(true);
  } }, buttonIcon) }))), import_react13.default.createElement("div", null, import_react13.default.createElement(row_default, null, import_react13.default.createElement(col_default, { span: 8, style: { textAlign: "right", opacity: 0.333, paddingRight: 6, fontSize: 24 } }, props.functionFragment.name), import_react13.default.createElement(col_default, { span: 16 }, inputs)), import_react13.default.createElement(divider_default, null));
};
var CodeView = (props) => import_react15.default.createElement("span", { className: "highlight", style: { marginLeft: 4, padding: 4, borderRadius: 4, fontWeight: "bolder" } }, props.children);
var NoContractDisplay = (props) => import_react15.default.createElement("div", { style: { padding: 16 } }, props.showLoading && "Loading...", import_react15.default.createElement("div", { style: { padding: 16 } }, "\u{1F91A}\u{1F3FD} Make sure you have deployed your contract and selected the right network!"), import_react15.default.createElement("div", { style: { padding: 16 } }, "You need to run", import_react15.default.createElement(CodeView, null, "yarn run chain"), "and", import_react15.default.createElement(CodeView, null, "to see your contract here.")), import_react15.default.createElement("div", { style: { padding: 16 } }, import_react15.default.createElement("span", { style: { marginRight: 4 }, role: "img", "aria-label": "warning" }, "\u2622\uFE0F"), "Warning: You might need to run", import_react15.default.createElement(CodeView, null, "yarn run deploy"), import_react15.default.createElement("i", null, "again"), " after the frontend comes up!"));
var { Text: Text3 } = typography_default;
var isQueryable = (fn) => (fn.stateMutability === "view" || fn.stateMutability === "pure") && fn.inputs.length === 0;
var GenericContract = (props) => {
  var _a, _b, _c;
  let ethersContext = useEthersContext(), contractIsDeployed = useContractExistsAtAddress(props.contract), [refreshRequired, setTriggerRefresh] = (0, import_react14.useState)(false), contractDisplay = (props.contract ? Object.values(props.contract.interface.functions).filter((fn) => fn.type === "function" && !(props.show && props.show.indexOf(fn.name) < 0)) : []).map((fn) => {
    var _a2, _b2, _c2, _d, _e;
    if (!ethersContext.signer)
      return import_react14.default.createElement(import_react14.default.Fragment, null);
    let contractFunc = fn.stateMutability === "view" || fn.stateMutability === "pure" ? (_a2 = props.contract) == null ? void 0 : _a2[fn.name] : (_c2 = (_b2 = props.contract) == null ? void 0 : _b2.connect(ethersContext.signer)) == null ? void 0 : _c2[fn.name];
    return typeof contractFunc == "function" ? isQueryable(fn) ? import_react14.default.createElement(DisplayVariable, { key: fn.name, contractFunction: (_d = props.contract) == null ? void 0 : _d[fn.name], functionInfo: fn, refreshRequired, setTriggerRefresh }) : import_react14.default.createElement(FunctionForm, { key: "FF" + fn.name, contractFunction: contractFunc, functionFragment: fn, gasPrice: (_e = props.gasPrice) != null ? _e : 0, setTriggerRefresh }) : null;
  }), fontSize = 24;
  return import_react14.default.createElement("div", { style: { margin: "auto", width: "70vw" } }, import_react14.default.createElement(card_default, { title: import_react14.default.createElement("div", null, import_react14.default.createElement(Text3, { style: { fontSize, verticalAlign: "middle" } }, props.contractName), import_react14.default.createElement("div", { style: { float: "right" } }, import_react14.default.createElement(Account, { signer: (_a = props.contract) == null ? void 0 : _a.signer, ensProvider: props.mainnetProvider, price: (_b = props.tokenPrice) != null ? _b : 0, blockExplorer: props.blockExplorer, fontSize, hasContextConnect: false }), props.addressElement)), size: "default", style: { marginTop: 25, width: "100%" }, loading: ethersContext.ethersProvider == null || ethersContext.signer == null }, contractIsDeployed ? contractDisplay : import_react14.default.createElement(NoContractDisplay, { showLoading: ethersContext.signer == null || ((_c = props.contract) == null ? void 0 : _c.provider) == null })));
};
...
//# sourceMappingURL=chunk-B7KUPBMH.js.map
