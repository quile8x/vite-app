...
import {
  require_base64_js,
  require_ieee754
} from "./chunk-FNCYMJXV.js";
import {
  require_events
} from "./chunk-7JJK6UJU.js";
import {
  buffer_exports,
  init_buffer
...
var require_buffer = __commonJS({
  "node_modules/qrcode/node_modules/buffer/index.js"(exports) {
    ...
    Buffer2.alloc = function(size, fill, encoding5) {
    ...
    function fromString(string, encoding5) {
      if (typeof encoding5 !== "string" || encoding5 === "") {
        encoding5 = "utf8";
      }
      if (!Buffer2.isEncoding(encoding5)) {
        throw new TypeError("Unknown encoding: " + encoding5);
      }
      var length = byteLength(string, encoding5) | 0;
      var buf = createBuffer(length);
      var actual = buf.write(string, encoding5);
      if (actual !== length) {
        buf = buf.slice(0, actual);
      }
      return buf;
    ...
    Buffer2.isEncoding = function isEncoding(encoding5) {
    ...
    function byteLength(string, encoding5) {
      if (Buffer2.isBuffer(string)) {
        return string.length;
      }
    ...
    function bidirectionalIndexOf(buffer, val, byteOffset, encoding5, dir) {
      if (buffer.length === 0)
        return -1;
      ...
      if (typeof val === "string") {
        val = Buffer2.from(val, encoding5);
      }
      if (Buffer2.isBuffer(val)) {
        if (val.length === 0) {
          return -1;
        }
        return arrayIndexOf(buffer, val, byteOffset, encoding5, dir);
      } else if (typeof val === "number") {
        val = val & 255;
    ...
    Buffer2.prototype.includes = function includes(val, byteOffset, encoding5) {
      return this.indexOf(val, byteOffset, encoding5) !== -1;
    };
    Buffer2.prototype.indexOf = function indexOf(val, byteOffset, encoding5) {
      return bidirectionalIndexOf(this, val, byteOffset, encoding5, true);
    };
    Buffer2.prototype.lastIndexOf = function lastIndexOf(val, byteOffset, encoding5) {
    ...
    Buffer2.prototype.write = function write(string, offset, length, encoding5) {
      if (offset === void 0) {
        encoding5 = "utf8";
        length = this.length;
        offset = 0;
    ...
    Buffer2.prototype.fill = function fill(val, start, end, encoding5) {
      if (typeof val === "string") {
        if (typeof start === "string") {
          encoding5 = start;
          start = 0;
        ...
        if (typeof encoding5 === "string" && !Buffer2.isEncoding(encoding5)) {
          throw new TypeError("Unknown encoding: " + encoding5);
        }
        if (val.length === 1) {
          var code = val.charCodeAt(0);
      ...
      if (typeof val === "number") {
        ...
        var bytes = Buffer2.isBuffer(val) ? val : Buffer2.from(val, encoding5);
        var len = bytes.length;
        if (len === 0) {
...
var require_cjs5 = __commonJS({
  "node_modules/@walletconnect/qrcode-modal/dist/cjs/index.js"(exports, module) {
    ...
    var browserUtils = (init_esm2(), esm_exports2);
...
// dep:@walletconnect_ethereum-provider
init_define_process_env();
...
var encoding = __toModule(require_cjs4());
...
var import_encoding = __toModule(require_cjs4());

// node_modules/@walletconnect/utils/dist/esm/misc.js
init_define_process_env();
var encoding2 = __toModule(require_cjs4());
...
init_define_process_env();
var encoding3 = __toModule(require_cjs4());
...
// node_modules/@walletconnect/iso-crypto/dist/esm/index.js
var encoding4 = __toModule(require_cjs4());
...
// dep:@walletconnect_ethereum-provider
var walletconnect_ethereum_provider_default = esm_default4;
export {
  walletconnect_ethereum_provider_default as default
};
/*!
