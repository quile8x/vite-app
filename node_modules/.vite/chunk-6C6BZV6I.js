...
import {
  ...
  splitSignature,
  stripZeros
} from "./chunk-VJNL7547.js";
import {
  Logger
} from "./chunk-ZF7OXGEH.js";
import {
  require_sha3
} from "./chunk-P366NTQY.js";
import {
  require_hash
} from "./chunk-HP5YREXV.js";
import {
  buffer_exports,
  init_buffer
} from "./chunk-3WMP62SJ.js";
import {
  __commonJS,
  __export,
  __toModule,
  init_define_process_env
} from "./chunk-2PHUQY7K.js";
...
init_define_process_env();
var version2 = "abstract-provider/5.7.0";
...
function getCreate2Address(from, salt, initCodeHash) {
  if (hexDataLength(salt) !== 32) {
    logger4.throwArgumentError("salt must be 32 bytes", "salt", salt);
  }
  if (hexDataLength(initCodeHash) !== 32) {
    logger4.throwArgumentError("initCodeHash must be 32 bytes", "initCodeHash", initCodeHash);
  }
...
init_define_process_env();
var version5 = "signing-key/5.7.0";
...
init_define_process_env();
var version6 = "transactions/5.7.0";
...
function checkTopic(topic) {
  ...
  if (hexDataLength(topic) !== 32) {
    logger13.throwArgumentError("invalid topic", "topic", topic);
  }
...
function getIpfsLink(link) {
  if (link.match(/^ipfs:\/\/ipfs\//i)) {
    ...
    logger13.throwArgumentError("unsupported IPFS format", "link", link);
  }
...
var Resolver = class {
    ...
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (arrayify(result).length % 32 === 4) {
          logger13.throwError("resolver threw error", Logger.errors.CALL_EXCEPTION, {
            transaction: tx,
            data: result
          });
        }
  ...
  _getAddress(coinType, hexBytes) {
    ...
    if (coinInfo == null) {
      logger13.throwError(`unsupported coin type: ${coinType}`, Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    if (coinInfo.prefix != null) {
      ...
      if (version14 >= 0 && bytes.length === 2 + length && length >= 1 && length <= 75) {
        const words = import_bech32.default.toWords(bytes.slice(2));
        words.unshift(version14);
  ...
  getAddress(coinType) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (address == null) {
        logger13.throwError(`invalid or unsupported coin data`, Logger.errors.UNSUPPORTED_OPERATION, {
          operation: `getAddress(${coinType})`,
          coinType,
          data: hexBytes
        });
  ...
  getContentHash() {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      return logger13.throwError(`invalid or unsupported content hash data`, Logger.errors.UNSUPPORTED_OPERATION, {
...
var BaseProvider = class extends Provider {
  constructor(network) {
    ...
    if (network instanceof Promise) {
      ...
      if (knownNetwork) {
        ...
        logger13.throwArgumentError("invalid network", "network", network);
      }
    }
    ...
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      for (let i = 0; i < urls.length; i++) {
        ...
        if (result.status >= 400 && result.status < 500) {
          return logger13.throwError(`response not found during CCIP fetch: ${errorMessage}`, Logger.errors.SERVER_ERROR, { url, errorMessage });
        }
        errorMessages.push(errorMessage);
      }
      return logger13.throwError(`error encountered during CCIP fetch: ${errorMessages.map((m) => JSON.stringify(m)).join(", ")}`, Logger.errors.SERVER_ERROR, {
        urls,
        errorMessages
      });
    });
  ...
  poll() {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (Math.abs(this._emitted.block - blockNumber) > 1e3) {
        logger13.warn(`network block skew detected; skipping block events (emitted=${this._emitted.block} blockNumber${blockNumber})`);
        this.emit("error", logger13.makeError("network block skew detected", Logger.errors.NETWORK_ERROR, {
          blockNumber,
          event: "blockSkew",
  ...
  detectNetwork() {
    return __awaiter6(this, void 0, void 0, function* () {
      return logger13.throwError("provider does not support network detection", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  getNetwork() {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (network.chainId !== currentNetwork.chainId) {
        ...
        const error = logger13.makeError("underlying network changed", Logger.errors.NETWORK_ERROR, {
          event: "changed",
          network,
      ...
      return new Promise((resolve, reject) => {
                ...
                while (scannedBlock <= blockNumber) {
                  ...
                  for (let ti = 0; ti < block.transactions.length; ti++) {
                    ...
                    if (tx.from === replaceable.from && tx.nonce === replaceable.nonce) {
                      ...
                      reject(logger13.makeError("transaction was replaced", Logger.errors.TRANSACTION_REPLACED, {
        ...
        if (typeof timeout === "number" && timeout > 0) {
          const timer2 = setTimeout(() => {
            ...
            reject(logger13.makeError("timeout exceeded", Logger.errors.TIMEOUT, { timeout }));
          }, timeout);
          if (timer2.unref) {
            timer2.unref();
          }
  ...
  getGasPrice() {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return logger13.throwError("bad result from backend", Logger.errors.SERVER_ERROR, {
          method: "getGasPrice",
          result,
          error
        });
  ...
  _wrapTransaction(tx, hash3, startBlock) {
    ...
    if (hash3 != null && tx.hash !== hash3) {
      logger13.throwError("Transaction hash mismatch from Provider.sendTransaction.", Logger.errors.UNKNOWN_ERROR, { expectedHash: tx.hash, returnedHash: hash3 });
    }
    result.wait = (confirms, timeout) => __awaiter6(this, void 0, void 0, function* () {
      ...
      if (receipt.status === 0) {
        logger13.throwError("transaction failed", Logger.errors.CALL_EXCEPTION, {
  ...
  _call(transaction, blockTag, attempt) {
    return __awaiter6(this, void 0, void 0, function* () {
      if (attempt >= MAX_CCIP_REDIRECTS) {
        logger13.throwError("CCIP read exceeded maximum redirections", Logger.errors.SERVER_ERROR, {
          redirects: attempt,
          transaction
        });
      }
      ...
      if (attempt >= 0 && blockTag === "latest" && txSender != null && result.substring(0, 10) === "0x556f1830" && hexDataLength(result) % 32 === 4) {
        try {
          ...
          if (!BigNumber.from(sender).eq(txSender)) {
            logger13.throwError("CCIP Read sender did not match", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
          ...
          for (let u = 0; u < urlsLength; u++) {
            ...
            if (url == null) {
              logger13.throwError("CCIP Read contained corrupt URL string", Logger.errors.CALL_EXCEPTION, {
                name: "OffchainLookup",
                signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
                transaction,
                data: result
          ...
          if (!BigNumber.from(hexDataSlice(data, 100, 128)).isZero()) {
            logger13.throwError("CCIP Read callback selector included junk", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
              signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
              transaction,
              data: result
          ...
          if (ccipResult == null) {
            logger13.throwError("CCIP Read disabled or provided no URLs", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
              signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
              transaction,
              data: result
  ...
  _getAddress(addressOrName) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (typeof addressOrName !== "string") {
        logger13.throwArgumentError("invalid address or ENS name", "name", addressOrName);
      }
      const address = yield this.resolveName(addressOrName);
      if (address == null) {
        logger13.throwError("ENS name not configured", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (isHexString(blockHashOrBlockTag, 32)) {
        ...
        try {
          ...
          logger13.throwArgumentError("invalid block hash or block tag", "blockHashOrBlockTag", blockHashOrBlockTag);
        }
      }
  ...
  _getBlockTag(blockTag) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (typeof blockTag === "number" && blockTag < 0) {
        if (blockTag % 1) {
          logger13.throwArgumentError("invalid BlockTag", "blockTag", blockTag);
        }
  ...
  _getResolver(name, operation) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (!network.ensAddress) {
        logger13.throwError("network does not support ENS", Logger.errors.UNSUPPORTED_OPERATION, { operation, network: network.name });
      }
      try {
  ...
  resolveName(name) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (typeof name !== "string") {
        logger13.throwArgumentError("invalid ENS name", "name", name);
      }
  ...
  perform(method, params) {
    return logger13.throwError(method + " not implemented", Logger.errors.NOT_IMPLEMENTED, { operation: method });
  }
  _startEvent(event) {
...
var Signer = class {
  constructor() {
    logger14.checkAbstract(new.target, Signer);
...
try {
  ...
  const logger29 = new Logger(version7);
  WS = function() {
    logger29.throwError("WebSockets not supported in this environment", Logger.errors.UNSUPPORTED_OPERATION, {
...
var logger17 = new Logger(version7);
...
init_define_process_env();
"use strict";
var logger18 = new Logger(version7);
...
init_define_process_env();
var logger19 = new Logger(version7);
...
var logger20 = new Logger(version7);
...
var logger21 = new Logger(version7);
...
var logger23 = new Logger(version7);
function now() {
  return new Date().getTime();
}
  ...
  for (let i = 0; i < networks.length; i++) {
    ...
    if (result) {
      if (!(result.name === network.name && result.chainId === network.chainId && (result.ensAddress === network.ensAddress || result.ensAddress == null && network.ensAddress == null))) {
        logger23.throwArgumentError("provider mismatch", "networks", networks);
      }
    } else {
      result = network;
    }
...
function getRunner(config, currentBlockNumber, method, params) {
  return __awaiter13(this, void 0, void 0, function* () {
    ...
    return logger23.throwError("unknown method error", Logger.errors.UNKNOWN_ERROR, {
      method,
      params
    });
  });
...
var FallbackProvider = class extends BaseProvider {
  constructor(providers, quorum) {
    if (providers.length === 0) {
      logger23.throwArgumentError("missing providers", "providers", providers);
    }
    const providerConfigs = providers.map((configOrProvider, index) => {
      ...
      if (weight % 1 || weight > 512 || weight < 1) {
        logger23.throwArgumentError("invalid weight; must be integer in [1, 512]", `providers[${index}].weight`, weight);
      }
    ...
    if (quorum == null) {
      ...
      logger23.throwArgumentError("quorum will always fail; larger than total weight", "quorum", quorum);
    }
    ...
    return __awaiter13(this, void 0, void 0, function* () {
      ...
      while (true) {
        ...
        Object.keys(errors).forEach((errorCode) => {
          ...
          logger23.throwError(e.reason || e.message, errorCode, props);
        });
      ...
      return logger23.throwError("failed to meet quorum", Logger.errors.SERVER_ERROR, {
        method,
        params,
...
init_define_process_env();
"use strict";
var logger24 = new Logger(version7);
...
var InfuraWebSocketProvider = class extends WebSocketProvider {
  constructor(network, apiKey) {
    ...
    if (connection.password) {
      logger24.throwError("INFURA WebSocket project secrets unsupported", Logger.errors.UNSUPPORTED_OPERATION, {
...
var InfuraProvider = class extends UrlJsonRpcProvider {
  ...
  static getApiKey(apiKey) {
    ...
    if (typeof apiKey === "string") {
      ...
      logger24.assertArgument(typeof apiKey.projectId === "string", "projectSecret requires a projectId", "projectId", apiKey.projectId);
      logger24.assertArgument(typeof apiKey.projectSecret === "string", "invalid projectSecret", "projectSecret", "[REDACTED]");
  ...
  static getUrl(network, apiKey) {
    ...
    switch (network ? network.name : "unknown") {
      ...
      case "arbitrum-goerli":
        ...
        break;
      default:
        logger24.throwError("unsupported network", Logger.errors.INVALID_ARGUMENT, {
          argument: "network",
          value: network
        });
    }
...
init_define_process_env();
"use strict";
var logger25 = new Logger(version7);
var defaultApiKey3 = "ETHERS_JS_SHARED";
var NodesmithProvider = class extends UrlJsonRpcProvider {
  static getApiKey(apiKey) {
    if (apiKey && typeof apiKey !== "string") {
      logger25.throwArgumentError("invalid apiKey", "apiKey", apiKey);
    }
    return apiKey || defaultApiKey3;
  }
  static getUrl(network, apiKey) {
    logger25.warn("NodeSmith will be discontinued on 2019-12-20; please migrate to another platform.");
    let host = null;
    switch (network.name) {
      case "homestead":
...
init_define_process_env();
"use strict";
var logger26 = new Logger(version7);
...
var PocketProvider = class extends UrlJsonRpcProvider {
  static getApiKey(apiKey) {
    ...
    if (apiKey == null) {
      ...
      logger26.throwArgumentError("unsupported PocketProvider apiKey", "apiKey", apiKey);
    }
    return apiKeyObj;
  }
  static getUrl(network, apiKey) {
...
init_define_process_env();
"use strict";
var logger27 = new Logger(version7);
var _nextId = 1;
...
var Web3Provider = class extends JsonRpcProvider {
  constructor(provider, network) {
    if (provider == null) {
      logger27.throwArgumentError("missing provider", "provider", provider);
    }
    let path = null;
    ...
    if (typeof provider === "function") {
      ...
      if (provider.request) {
        ...
        logger27.throwArgumentError("unsupported provider", "provider", provider);
      }
      if (!path) {
        path = "unknown:";
      }
...
init_define_process_env();
"use strict";
var logger28 = new Logger(version7);
  ...
  if (typeof network === "string") {
    ...
    if (match) {
      switch (match[1].toLowerCase()) {
        ...
        default:
          logger28.throwArgumentError("unsupported URL scheme", "network", network);
      }
    }
  }
  const n = getNetwork(network);
  if (!n || !n._defaultProvider) {
    logger28.throwError("unsupported getDefaultProvider network", Logger.errors.NETWORK_ERROR, {
...
//# sourceMappingURL=chunk-6C6BZV6I.js.map
