...
var useBalance = (address) => {
  let isMounted = useIsMounted_default(), { ethersProvider } = useEthersContext(), blockNumber = useBlockNumberContext(), [balance, setBalance] = (0, import_react3.useState)(zero), callFunc = (0, import_react3.useCallback)(async () => {
...
var useBurnerSigner = (localProvider) => {
  var _a;
  let key = "scaffold-eth-burner-privateKey", [privateKeyValue, setPrivateKey] = (0, import_react5.useState)(), walletRef = (0, import_react5.useRef)(), creatingBurnerRef = (0, import_react5.useRef)(false), [signer] = useDebounce(walletRef.current, 200, { trailing: true }), [account] = useDebounce((_a = walletRef.current) == null ? void 0 : _a.address, 200, { trailing: true }), setValue = (value) => {
    try {
  ...
  let saveToStorage = (0, import_react5.useCallback)(() => {
    console.log("\u{1F511} Incoming Private Key..."), privateKeyValue != null && saveBurnerKeyToStorage(privateKeyValue);
  }, [privateKeyValue]), generateBurnerSigner = (0, import_react5.useCallback)(() => {
  ...
  }, [localProvider]), loadOrGenerateBurner = (0, import_react5.useCallback)(() => {
...
var useContractExistsAtAddress = (contract) => {
  let isMounted = useIsMounted_default(), [contractIsDeployed, setContractIsDeployed] = (0, import_react6.useState)(false), blockNumber = useBlockNumberContext(), callFunc = (0, import_react6.useCallback)(async () => {
...
var useContractLoader = (config = {}, providerOrSigner, configChainId) => {
  let isMounted = useIsMounted_default(), { ethersProvider, chainId: contextChainId } = useEthersContext(), chainId = configChainId != null ? configChainId : contextChainId, [contracts, setContracts] = (0, import_react7.useState)({}), configDep = (0, import_react7.useMemo)(() => `${JSON.stringify(config != null ? config : {})}, ${JSON.stringify({ chainId })}`, [chainId, config]), callFunc = (0, import_react7.useCallback)(() => {
    var _a, _b;
...
var useContractReader = (contract, contractFunctionInfo, formatter, onChange) => {
  let isMounted = useIsMounted_default(), [value, setValue] = (0, import_react8.useState)(), blockNumber = useBlockNumberContext(), ethersContext = useEthersContext(), callContractFunction = (0, import_react8.useCallback)(async () => {
    var _a;
    ...
    return result;
  }, [contract, contractFunctionInfo.functionArgs, contractFunctionInfo.functionName]), contractProvider = contract == null ? void 0 : contract.provider, callFunc = (0, import_react8.useCallback)(async () => {
    var _a;
...
var useEventListener = (contract, eventName, startBlock) => {
  let isMounted = useIsMounted_default(), [eventMap, setEventMap] = (0, import_react9.useState)([]), queryEvents = (0, import_react9.useCallback)((_listenerArgs) => {
    (async () => {
  ...
  }, [contract == null ? void 0 : contract.queryFilter]), (0, import_react9.useEffect)(() => {
    try {
...
var useGasPrice = (chainId, speed, currentNetworkInfo) => {
  let { ethersProvider } = useEthersContext(), blockNumber = useBlockNumberContext(), [currentChainId, setCurrentChainId] = (0, import_react10.useState)(), [gasPrice, setGasPrice] = (0, import_react10.useState)(), [gasPriceDebounced] = useDebounce(gasPrice, 250, { trailing: true }), callFunc = (0, import_react10.useCallback)(() => {
...
var useGetUserFromProviders = (currentProvider, ...moreProviders) => {
  let [signer, setSigner] = (0, import_react11.useState)(), [provider, setProvider] = (0, import_react11.useState)(), [providerNetwork, setProviderNetwork] = (0, import_react11.useState)(), [address, setAddress] = (0, import_react11.useState)(), allProviders = [currentProvider, ...moreProviders].filter((f) => f != null), providerDeps = allProviders.map((m) => {
    var _a, _b;
  ...
  }).reduce((acc, value) => acc ? acc + value : value != null ? value : "", ""), callFunc = (0, import_react11.useCallback)(async () => {
...
var useGetUserFromSigners = (signer) => {
  let [resolvedSigner, setResolvedSigner] = (0, import_react12.useState)(), [provider, setProvider] = (0, import_react12.useState)(), [providerNetwork, setProviderNetwork] = (0, import_react12.useState)(), [address, setAddress] = (0, import_react12.useState)(), callFunc = (0, import_react12.useCallback)(async () => {
...
var useNonce = (address) => {
  let isMounted = useIsMounted_default(), { ethersProvider } = useEthersContext(), blockNumber = useBlockNumberContext(), [nonce, setNonce] = (0, import_react13.useState)(0), callFunc = (0, import_react13.useCallback)(async () => {
    var _a;
    let nextNonce = 0;
    try {
...
var useOnRepetition = (callback, options, ...args) => {
  ...
  }, [options.provider, readyForEvents, listener]), (0, import_react14.useEffect)(() => {
    var _a2;
    let tick = () => {
  ...
  }, [options.pollTime, isPolling, callFunctionWithArgs]), (0, import_react14.useEffect)(() => {
    isFirstCall.current || (isFirstCall.current = true);
  }, [argDeps]), (0, import_react14.useEffect)(() => {
...
var useTimestamp = () => {
  let isMounted = useIsMounted_default(), { ethersProvider } = useEthersContext(), blockNumber = useBlockNumberContext(), [timestamp, setTimestamp] = (0, import_react15.useState)(0), callFunc = (0, import_react15.useCallback)(async () => {
    if (blockNumber != null) {
...
var useUserAddress = (signer) => {
  let isMounted = useIsMounted_default(), [userAddress, setUserAddress] = (0, import_react16.useState)(), blockNumber = useBlockNumberContext(), callFunc = (0, import_react16.useCallback)(async () => {
...
var useWeb3Modal = (web3ModalConfig, setCurrentEthersProvider) => {
  var _a;
  let web3ModalProviderRef = (0, import_react17.useRef)(), initalizingRef = (0, import_react17.useRef)();
  ...
  let reloadPage = (0, import_react17.useCallback)(() => (_param) => {
    var _a2;
    ((_a2 = web3ModalProviderRef.current) == null ? void 0 : _a2.cachedProvider) && setTimeout(() => {
      window.location.reload();
    }, 1);
  }, []), logoutOfWeb3ModalCallback = (0, import_react17.useCallback)((reload = true) => {
    initalizingRef.current = false, setCurrentEthersProvider(void 0), reload && reloadPage();
  }, [setCurrentEthersProvider]), loadWeb3Modal = (0, import_react17.useCallback)(async () => {
    var _a2;
    try {
  ...
  let openWeb3ModalCallback = (0, import_react17.useCallback)(() => {
    var _a2;
    setCurrentEthersProvider(void 0), (_a2 = web3ModalProviderRef.current) == null || _a2.clearCachedProvider(), loadWeb3Modal();
  }, [loadWeb3Modal]), updateWeb3ModalThemeCallback = (0, import_react17.useCallback)((theme) => {
    var _a2;
...
var useBlockNumber = (provider, pollTime = 0) => {
  let [blockNumber, setBlockNumber] = (0, import_react4.useState)(0), isMounted = useIsMounted_default(), getBlockNumber = (0, import_react4.useCallback)(async () => {
...
//# sourceMappingURL=chunk-CJZDMFCT.js.map
