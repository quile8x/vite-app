...
interface YourCollectible2Interface extends ethers.utils.Interface {
  functions: {
...
export class YourCollectible2 extends BaseContract {
  ...
  interface: YourCollectible2Interface;
