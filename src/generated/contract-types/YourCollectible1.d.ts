...
interface YourCollectible1Interface extends ethers.utils.Interface {
  functions: {
...
export class YourCollectible1 extends BaseContract {
  ...
  interface: YourCollectible1Interface;
